...
function withSuperJSONPage(Page) {
    function WithSuperJSON(serializedProps) {
        if (!serializedProps._superjson) {
            var PageWithoutProps = Page;
            return React.createElement(PageWithoutProps, __assign({}, serializedProps));
        }
        var props = superjson_1["default"].deserialize(serializedProps);
